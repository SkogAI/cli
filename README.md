...
- 🎯 Entry points to execute your program using `python -m <cli>` or `$ cli` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/SkogAI/cli/branch/main/graph/badge.svg?token=cli_token_here)](https://codecov.io/gh/SkogAI/cli)
[![CI](https://github.com/SkogAI/cli/actions/workflows/main.yml/badge.svg)](https://github.com/SkogAI/cli/actions/workflows/main.yml)

Awesome cli created by SkogAI

## Install

from source
```bash
git clone https://github.com/SkogAI/cli cli
cd cli
make install
```
...
```bash
❯ cli create-user --help
Usage: cli create-user [OPTIONS] USERNAME PASSWORD
...
```bash
cli create-user admin admin --superuser
```
...
Run with `cli run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `cli create-user`.
...
-----------------------------------------------------
cli/__init__.py              4      0   100%
cli/app.py                  16      1    94%
cli/cli.py                  21      0   100%
cli/config.py                5      0   100%
cli/db.py                   10      0   100%
cli/models/__init__.py       0      0   100%
cli/models/content.py       47      1    98%
cli/routes/__init__.py      11      0   100%
cli/routes/content.py       52     25    52%
cli/routes/security.py      15      1    93%
cli/routes/user.py          52     26    50%
cli/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in cli/default.toml.
